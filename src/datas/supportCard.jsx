export const supportCard = [
  {
    ...
    description: (
      <>
        별도의 개발 비용 없이 렌탈사에서 <br />
        삼성전자 가전 전문 온라인 <br className="md:hidden" />
        쇼핑몰을 제공합니다
      </>
    ),
  },
  {
    ...
    description: (
      <>
        가전 렌탈 영업 노하우, 상품 지식, <br className="md:hidden" />
        온라인 마케팅까지 초보자도 <br />
        바로 시작할 수 있는 단계별 교육을 제공합니다
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        SNS 콘텐츠, 상세페이지, 홍보 이미지 등 <br />
        판매에 필요한 마케팅 자료를 <br className="md:hidden" />
        렌탈사에서 제공합니다
      </>
    ),
  },
