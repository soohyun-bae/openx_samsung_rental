export const reliabilityCardData = [
  ...
  },
  {
    ...
    lgText: (
      <p className="font-line text-reliability-lg leading-[clamp(30px,calc((44/1920)*100vw),44px)]">
        가전 렌탈 시장의 <br />
        <span className="text-subTitle font-bold">폭발적 성장</span>
      </p>
    ),
    smText: (
      <>
        가전 렌탈 시장은 매년 성장 중이며 <br />
        시장 점유율은 빠르게 확대되고 있습니다
      </>
    ),
  },
  {
    ...
    lgText: (
      <p className="font-line text-reliability-lg leading-[clamp(30px,calc((44/1920)*100vw),44px)]">
        비스포크 가전, <br />
        <span className="text-subTitle font-bold">글로벌 품질 인증</span>
      </p>
    ),
    smText: (
      <>
